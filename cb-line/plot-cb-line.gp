...
set output OUT_FILE
plot data("A.cdf.gz") u 1:2 t 'A' w l ls 3 dt 2, \
     data("B.cdf.gz") u 1:2 t 'B' w l ls 7 dt 1, \
     data("C.cdf.gz") u 1:2 t 'C' w l ls 5 dt 3, \
     data("D.cdf.gz") u 1:2 t 'D' w l ls 1 dt 4, \
     data("E.cdf.gz") u 1:2 t 'E' w l ls 2 dt 5, \
     data("F.cdf.gz") u 1:2 t 'F' w l ls 4 dt 7, \
